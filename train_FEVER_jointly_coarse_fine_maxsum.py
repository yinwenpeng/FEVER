...
def evaluate_lenet5(learning_rate=0.02, n_epochs=100, emb_size=300, batch_size=50, filter_size=[3], sent_len=40, claim_len=40, cand_size=10,hidden_size=[300,300], max_pred_pick=5):
    ...
    joint_LR_input = T.concatenate([joint_premise_hypo_emb,fine_max,fine_sum], axis=1)
    joint_LR_input_size=2*hidden_size[0]+2*hidden_size[0]+2*hidden_size[0]
    ...
    test_LR_input = T.concatenate([test_premise_hypo_emb, test_fine_max, test_fine_sum], axis=1)
